...
<head>
	...
	<!--
		if (screen.width <= 800) {
		window.location = "productos-m.php";
		}
	  //-->
	</script>
...
<body>
	...
	<div class='homepage' id="home_page">
		<div class="featured-products">
			<h3 class="">Listado de Productos</h2><br>
				<h4 class="">Este es el listado completo de productos para Bogotá</h4>
					<section class="grid">
						<?php				
							$sql = "select * from producto where en_inventario='si' and producto_padre='si' order by orden_importancia asc";					
						...
						<div class="featured-product">							
							<a href="productos/producto.php?id_producto=<?php echo $reg["id_producto"];?>" class="product color-picker" data-impressionable data-clicktrackable data-id="131" data-position="100" data-list="Featured Products">
								<img alt="" class="product-shot" src="panel/catalogo/img/thumbnail/<?php echo $reg["foto_grande"]; ?>" width="235px" height="300px"/>
									<div class='colors'>
											<?php				
		...
		<!--<div id="auto_refill">
			<section class="module how-it-works">
				<h2 class="title">Las 3 Opciones</h2>
				<ul class="steps">
						<li class="step">
							<span class="number">1</span>
							<p class="head">Envios Recurrentes</p>
							<p class="body">This will determine how<br> often we deliver to you</p><br><br>							
						</li>
						<li class="step">
							<span class="number">2</span>
							<p class="head">Ocasiones Especiales</p>
							<p class="body">Choose from blades,<br> Rosese gel, after Rosese</p><br><br>							
						</li>
						<li class="step">
							<span class="number">3</span>
							<p class="head">Porque Sí</p>
							<p class="body">Free shipping always,<br> cancel or modify any time</p><br><br>							
						</li>
				</ul>
				<a href="" class="button medium pale-blue">Get Started</a>
			</section>
			<section class="module product-features grid" data-product-features>
				<div class="image col-1-2">
						<img src="https://lh3.googleusercontent.com/aTDrMIm1aIxIPHBRb-j-SIvKuqy1M1sFHBphnTB03_k=w1500-h600-no" data-product-image="Harry&#x27;s Blades" class="active">
						<img src="assets/auto-refill/shaving-gel-814ed91169470d5d1bd4463f91140ec0.jpg" data-product-image="Rosesing Gel" class="">
						<img src="assets/auto-refill/after-shave-ed90dc73c4553814aa4ba75b4dd9eb4d.jpg" data-product-image="After Shave" class="">
				</div>
				<div class="text col-1-2">
					<h2 class="title">Products engineered and<br class='mobile'> formulated<br class='desktop'> for quality<br class='mobile'> and comfort</h2>
					<div class="product-links">
							<span data-product-action="Harry&#x27;s Blades" class="product-link active">
								Harry&#x27;s Blades
							</span>
							|
							<span data-product-action="Shaving Gel" class="product-link ">
								Rosesing Gel
							</span>
							|
							<span data-product-action="After Shave" class="product-link ">
								After Rosese
							</span>							
					</div>
						<ul data-product-feature-list="Harry&#x27;s Blades" class="features active">
								<li class="feature">German-engineered precision blades</li>
								<li class="feature">Hinge cartridge for flexibility and control</li>
								<li class="feature">Delivers a crisp, comfortable Rosese</li>
						</ul>
