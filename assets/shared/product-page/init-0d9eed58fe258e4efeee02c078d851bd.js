...
}, L = /[\-+]?[\d]*\.?[\d]+/g, P = /\{\?\}/g, U = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g, O = /[a-z\-]+-gradient/g, W = "", G = "", N = function() {
...
Fe = 1, ue = i, ge = i, $e = "down", Re = -1, Pe = 0, Ue = 0, Oe = !1, me = i, fe = i, 
...
var e = [];
return U.lastIndex = 0, t = t.replace(U, function(t) {
...
var e = 1;
return P.lastIndex = 0, t[0].replace(P, function() {
return t[e++];
});
}, oe = function(t, e) {
t = [].concat(t);
...
}, Ae = 0, Fe = 1, $e = "down", Re = -1, Le = qe(), Pe = 0, Ue = 0, Oe = !1, We = 0, Ge = !1, Ne = 0, De = [];
...
}), n.active_mod_section.setIdByURL()), _.each($$("body .video"), function(t) {
new Video(t);
