					...
					<div class="product-hero gallery active" data-current-hero="true" data-hero-type="gallery" data-hero-id="131">
						<ul class="frame">
							...
							<div class="thumbnails">
								<?php				
									$sql4="select * from fotos_adicionales where id_producto='$id_producto'"; 
									$res4 = mysql_query($sql4,$con);
									while($reg4 = mysql_fetch_array($res4)){
								?>
								<li class="thumbnail " data-id="1">
									<a href="producto-adicional.php?id_producto=<?php echo $id_producto?>&id_fotos_adicionales=<?php echo $reg4["id_fotos_adicionales"];  ?>">
										<img alt="" src="../panel/catalogo/img/adicionales/thumbnail/<?php echo $reg4["foto_adicional_2"]; ?>" />
									</a>
								</li>
								<!--<li class="thumbnail " data-id="0">
									<a href="producto-adicional.php?id_producto=<?php echo $id_producto?>&id_fotos_adicionales=<?php echo $reg4["id_fotos_adicionales"];  ?>">
										<img alt="" src="../panel/catalogo/img/adicionales/thumbnail/<?php echo $reg4["foto_adicional_4"]; ?>" />
									</a>
								</li>-->
								<?php
									}
						...
						<div class="product form ">
							...
							<p class="museo availability">
								...
								<span class="all" style="display: block;">
									- Envio Gratis Dentro del Perímetro <a href="http://www.floresymaspremium.com/perimetros">(Ver Perímetros)</a>
								</span>
								<span class="all" style="display: block;">
									- Este Producto Incluye: <?php echo $reg["unidades_de_rosas"]; ?> Unidades de Rosas / De Color <?php echo $reg["colores_de_rosas"]; ?> Calidad Exportación!
								</span>
							</p>
