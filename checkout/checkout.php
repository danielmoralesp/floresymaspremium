...
<head>
	...
	<!--
		if (screen.width <= 800) {
		window.location = "checkout-m.php?id_pedidos=<?php echo $id_pedidos?>&id_usuario=<?php echo $id_usuario?>";
		}
	  //-->
	</script>    
	...
	<!-- VALIDADORES-->	
	<script language="javascript" type="text/javascript" src="../assets/validacion/validar-checkout.js"></script>
...
<body>
    ...
    <div class='global-wrapper'>
		...
		<div class="wrapper">
			...
			<h1 class="black-blue"><?php  echo chao_tilde('Información de Envío')?></h1>
			<aside class="summary" id="order_summary">
				<form name="form" accept-charset="UTF-8" action="procesar_checkout.php?id_pedidos=<?php echo $reg["id_pedidos"];?>" method="post" enctype="multipart/form-data">				
					...
					<div class="checkout-summary">
						...
						<p class="dark-blue shipping"><?php  echo chao_tilde('Envío')?> <span class="price" style="font-style: italic;">gratis</span></p>
			...
			<span class="page-error-msg" style="display: none;"></span>
				...
				<div class="need-shipping" style="display: block">					
						<div class="form address shipping grid" style="display: block">	
							...
							<?php
								$sql2="select * from producto where nombre_del_producto='$nombre_del_producto' and menos_de_90_min='si'"; 
							...
							<div class="col-2-3 grid pad-r">								
								<div class="col-1-2 pad-r">									
									<label for="billing_month" style="display: none;"></label>
						...
						<div class="shipping-options" data-default="1">							
							...
							<p><a href="http://www.floresymaspremium.com/perimetros" target="_blank"><?php  echo chao_tilde('Ver Perímetros')?></a></p>
						</div><hr>
						<div class="form address shipping grid" style="display: block">	
							<div class="col-1-1">
								<p class="h6 black-blue"><?php  echo chao_tilde('Envío y Recepción')?></p>								
								<input id="shipping_name" type="text" placeholder="Nombre de Quien Envia" name="nombre_de_quien_envia" class="address_line_1" value="">
								<div  class="error-msg" id="div_nombre_de_quien_envia"></div>
							</div>
							<div class="col-1-1">								
								<input id="shipping_address_line_1" type="text" placeholder="Nombre de Quien Recibe" name="nombre_de_quien_recibe" class="address_line_1"  value="">
								<div  class="error-msg" id="div_nombre_de_quien_recibe"></div>
							</div>
							<div class="col-1-1">								
								<input id="shipping_address_line_2" type="text" placeholder="Telefono de Quien Recibe" name="telefono_de_quien_recibe" class="address_line_2"  value="">
								<div  class="error-msg" id="div_telefono_de_quien_recibe"></div>
							</div>
							<div class="col-1-1">								
								<textarea id="shipping_city" type="text" placeholder="Mensaje de la Tarjeta" name="mensaje_para_tarjeta" class="city" maxlength="500" value=""></textarea>
								<div  class="error-msg" id="div_mensaje_para_tarjeta"></div>
							</div>							
							<div class="col-1-1">
								<textarea id="shipping_city" type="text" placeholder="Observaciones" name="observaciones_comentarios" class="city" maxlength="1000" value=""></textarea>
							</div>
						</div>
						  <br><br>
