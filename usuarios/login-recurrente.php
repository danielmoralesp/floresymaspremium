...
<head>
	...
	<!--
		if (screen.width <= 800) {
		window.location = "login-recurrente-m.php?id_pedidos_plan_continuidad=<?php echo $reg["id_pedidos_plan_continuidad"];?>";
		}
	  //-->
	</script>
	...
	<!-- VALIDADORES-->	
	<script language="javascript" type="text/javascript" src="../assets/validacion/validar-login-recurrente.js"></script>
		...
		<?php require_once("../instancias/header2.php"); ?>   
			<div class="devise radio-option" data-option="radio">
				...
				<section class="login center wrap-1000" id="auth_form">
					...
					<form name="form" accept-charset="UTF-8" action="logueo2-recurrente.php?id_pedidos_plan_continuidad=<?php echo $reg["id_pedidos_plan_continuidad"];?>" class="form" id="login_form" method="post">
						<div style="margin:0;padding:0;display:inline">
							...
							<a href="forgot-password-recurrente.php?id_pedidos_plan_continuidad=<?php echo $reg["id_pedidos_plan_continuidad"];?>"><span id="forgot_link" class="link forgot" style="display: inline-block;"><?php echo chao_tilde('¿Olvidó su Password?')?></span></a>							
						</div>
					</form>
					<input type="button" class="button blue medium bottom" value="Ingresar" onClick="validar()">
					<a href="crear-usuario-recurrente.php?id_pedidos_plan_continuidad=<?php echo $reg["id_pedidos_plan_continuidad"];?>" class="facebook"><span class="link">No tengo cuenta</span></a>
				</section>						
			</div>
	</div><br><br><br>
