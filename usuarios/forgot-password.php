...
<head>
	...
	<!--
		if (screen.width <= 800) {
		window.location = "forgot-password-m";
		}
	  //-->
	</script>
	...
	<!-- VALIDADORES-->	
	<script language="javascript" type="text/javascript" src="../assets/validacion/validar-forgot-password.js"></script>
    ...
    <div class='global-wrapper'>
		...
		<!-- Login -->
			...
			<h1 class="black-blue" id="title"><?php echo chao_tilde('Olvide Mi Contraseña')?></h1>
				<form name="form" accept-charset="UTF-8" action="reset-password" class="new_user" id="forgot_form" method="post" style="display: block;">
