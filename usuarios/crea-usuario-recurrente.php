<?php
	require_once("../conexion.php");
		...
		$remitente="FloresyMas.co <ventas@floresymas.co>";
			$asunto="Bienvenido a FloresyMas Premium - Planes";
							...
							<div id="flashes">
								...
								<div class="cart" id="view_edit_cart">
									<div class="wrap-1100 center clear" id="heading">
										<h1>Bienvenido a  FloresyMas Premium - Planes</h1>
									</div>
									<div>
			...
			echo "<script type='text/javascript'>
				window.location='../planes/envios-recurrentes/paso4.php?id_pedidos_plan_continuidad=$id_pedidos_plan_continuidad&id_usuario=$id_usuario';
			</script>";		
