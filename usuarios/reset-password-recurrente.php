		...
		$sql2 ="SELECT user
			...
			if(mysql_num_rows($res2) == $_POST["user"]){
				...
				echo "<script type='text/javascript'>
						...
						window.location='forgot-password-recurrente?id_pedidos_plan_continuidad=".$_GET["id_pedidos_plan_continuidad"]."';
					  </script>";
			}else{	
			
		
			$remitente="FloresyMas.co <ventas@floresymas.co>";
			$asunto="Usuario y Password - FloresyMas Premium - Planes";
							...
							<div id="flashes">
								...
								<div class="cart" id="view_edit_cart">
									<div class="wrap-1100 center clear" id="heading">
										<h1>Usuario y Password - FloresyMas Premium - Planes</h1>
									</div>
									<div>
									...
									<div class="wrap-1100 center clear">
										<ul>
											...
											<li>
												<p>Login: <a href="http://www.floresymaspremium.com/usuarios/login-recurrente.php?id_pedidos_plan_continuidad='.$id_pedidos_plan_continuidad.'">http://www.floresymaspremium.com/usuarios/login</a></p>
											</li>
											<li>
			...
			echo "<script type='text/javascript'>
						...
						window.location='login-recurrente.php?id_pedidos_plan_continuidad=$id_pedidos_plan_continuidad';
					  </script>";
