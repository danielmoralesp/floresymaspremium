...
<head>
	...
	<!-- VALIDADORES-->	
	<script language="javascript" type="text/javascript" src="../assets/validacion/validar-perfil.js"></script>
		...
		<?php require_once("../instancias/header2.php"); ?>   
			<div class="devise radio-option" data-option="radio">
				...
				<section class="login center wrap-1000" id="auth_form">
					<h1 class="black-blue" id="title">Perfil</h1>
					<form name="form" action="logueo-perfil" class="form" id="login_form" method="post">
						<div style="margin:0;padding:0;display:inline">
							...
							<div class="field">
								...
								<a href="forgot-password"><span id="forgot_link" class="link forgot" style="display: inline-block;"><?php echo chao_tilde('¿Olvidó su Password?')?></span></a>
