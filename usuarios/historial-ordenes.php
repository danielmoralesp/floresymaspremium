...
<body> 
    <div class='global-wrapper'>
		...
		<div class="center wrap-1240 rel">
			...
			<?php			
			$sql2 = "select * from pedidos where id_usuario='$id_usuario' order by id_pedidos desc";   		
			...
			<section id="details_name">			
				<div class="show view">
					...
					<div class="right table">
						<div class="middle">
							<a href="historial-ordenes-usuario.php?id_pedidos=<?php echo $reg2["id_pedidos"]; ?>&id_usuario=<?php echo $reg2["id_usuario"]; ?>"><span class="link edit">Ver</span></a>
						</div>
					</div>
				</div>			
			</section>
