...
<head>
	...
	<!--
		if (screen.width <= 800) {
		window.location = "crear-usuario-m.php?id_pedidos=<?php echo $id_pedidos?>";
		}
	  //-->
	</script>
	...
	<!-- VALIDADORES-->	
	<script language="javascript" type="text/javascript" src="../assets/validacion/validar-crear-usuario.js"></script>
    ...
    <div class='global-wrapper'>
		...
		<!-- Login -->
			<section class="login center wrap-1000" id="auth_form">
				<h1 class="black-blue" id="title">Soy Nuevo, <br>Crear Cuenta<Crear Cuenta</h1>
				<form name="form" accept-charset="UTF-8" action="crea-usuario" class="form" id="login_form" method="post">
					...
					<div class="field">
						...
						<input id="user" name="user" size="30" type="email"  placeholder="Email">
				...
				<a href="login.php?id_pedidos=<?php echo $reg["id_pedidos"];?>" class="facebook"><span class="link">Ya tengo cuenta</span></a>
			</section>			
		</div>
        <div class='push'></div>
    </div>
