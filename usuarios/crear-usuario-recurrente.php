<?php	
	...
	$sql="select * from pedidos_plan_continuidad where id_pedidos_plan_continuidad='".$_GET["id_pedidos_plan_continuidad"]."'"; 
...
<head>
	...
	<!--
		if (screen.width <= 800) {
		window.location = "crear-usuario-recurrente-m.php?id_pedidos_plan_continuidad=<?php echo $id_pedidos_plan_continuidad?>";
		}
	  //-->
	</script>
	...
	<!-- VALIDADORES-->	
	<script language="javascript" type="text/javascript" src="../assets/validacion/validar-crear-usuario-recurrente.js"></script>
    ...
    <div class='global-wrapper'>
		...
		<!-- Login -->
			<section class="login center wrap-1000" id="auth_form">
				<h1 class="black-blue" id="title">Soy Nuevo, <br>Crear Cuenta<</h1>
				<form name="form" accept-charset="UTF-8" action="crea-usuario-recurrente.php?id_pedidos_plan_continuidad=<?php echo $reg["id_pedidos_plan_continuidad"];?>" class="form" id="login_form" method="post">
					<div style="margin:0;padding:0;display:inline">
						<input name="utf8" type="hidden" value="&#x2713;" />
						<input name="authenticity_token" type="hidden" value="CxvHDtOhp8Ql4YjKfgTH7fPQsqPnpDgKVqEKmxK+TvE=" />
					</div>
					<div class="field">
					...
					<div class="field">
						...
						<input id="pass" name="pass" size="30" type="password" placeholder="Crear Password">
				...
				<input type="button" class="button blue medium bottom" value="Crear Cuenta" onClick="validar()">
				<a href="login-recurrente.php?id_pedidos_plan_continuidad=<?php echo $reg["id_pedidos_plan_continuidad"];?>" class="facebook"><span class="link">Ya tengo cuenta</span></a>
			</section>
		</div>
        <div class='push'></div>
    </div>
