...
<html>
<head>
	<title>Reporte Estado de Resultados | FloresyMas.co</title>
...
<body>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper" class="form-page">
			<h3>Reporte Estado de Resultados</h3><br><br>
            <div class="row form-wrapper">                							
						
				<!-- left column -->
                <div class="col-md-8 column">				
                    <form name="form" action="estado-de-resultados-dia" method="post">					
                        <div class="field-box">
							<label>Fecha de Consulta * Dia:</label>
							<div class="col-md-7">
