<?php
	...
	$sql = "select * from pedido_manual where estado_pedido='pendiente' order by id_pedido_manual desc";   
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="first">
								...
								<td>
                                   <span class="label label-warning"> <?php echo $reg["email_de_quien_llama"];?></span>
                                </td>
                                <td>
