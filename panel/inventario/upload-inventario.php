...
<html>
<head>
	<title>Nuevo Inventario | FloresyMas.co</title>
...
<body>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper" class="form-page">
			<h3>Nuevo Inventario</h3><br><br>
            <div class="row form-wrapper">
				<!-- left column -->
                <div class="col-md-8 column">				
                    <form name="form" action="procesar-upload-inventario" method="post">					
                        <h4>Nuevos Porducto en Inventario ------------</h3><br><br>				
						<div class="field-box">
