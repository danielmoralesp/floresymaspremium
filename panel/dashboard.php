...
<body>
    ...
    <header class="navbar navbar-inverse" role="banner">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="img/logo-dashboard.png" alt="logo" />
            </a>
        </div>
    ...
    <div class="content">
        ...
        <div id="main-stats">
            <div class="row stats-row">
				...
				<div class="col-md-3 col-sm-3 stat">
                    <div class="data">
                        <span class="number">$2.304.000</span>
                        Ventas
                    </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            // jQuery Flot Chart
            var visits = [[1, 21000000], [2, 20000000], [3, 23000000], [4, 22000000],[5, 18000000],[6, 17000000],[7, 22000000]];
            var visitors = [[1, 2500000], [2, 1800000], [3, 2300000], [4, 1000000],[5, 1800000],[6, 1890000],[7, 2100000]];

            var plot = $.plot($("#statsChart"),
                [ { data: visits, label: "Ventas"},
                 { data: visitors, label: "Adds" }], {
                    series: {
                        lines: { show: true,
                                lineWidth: 1,
                                fill: true, 
