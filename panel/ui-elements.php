...
<body>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper">
            <div class="row section btns">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row ctrls">
                        ...
                        <ul class="pagination inverse pull-left">
                            <li><a href="#">&#8249;</a></li>
                            <li class="active"><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
                            <li><a href="#">3</a></li>
            ...
            <div class="row section btns">
                <div class="col-md-6">
                    <h4 class="title">Bootstrap 3 buttons</h4>
                    <table>
                        <tr>
                            <td><code>.btn.btn-default</code></td>
                            <td><a class="btn btn-default">Sign up now</a></td>
                        </tr>
                        <tr>
                            <td><code>.btn.btn-primary</code></td>
                            <td><a class="btn btn-primary">Sign up now</a></td>
                        </tr>
                        <tr>
                            <td><code>btn.btn-success</code></td>
                            <td><a class="btn btn-success">Sign up now</a></td>
                        </tr>
                        <tr>
                            <td><code>btn.btn-warning</code></td>
                            <td><a class="btn btn-warning">Sign up now</a></td>
                        </tr>
                        <tr>
                            <td><code>btn.btn-info</code></td>
                            <td><a class="btn btn-info">Sign up now</a></td>
                        </tr>
                        <tr>
                            <td><code>btn.btn-danger</code></td>
                            <td><a class="btn btn-danger">Sign up now</a></td>
                        </tr>                        
                    </table>
                </div>
                <div class="col-md-5">
                    <h4 class="title">Bootstrap 3 elements</h4>
                    <div class="row ctrls">
                        <div class="dropdown">
