<?php
	...
	$sql = "select * from pedido_manual where estado_pedido='realizado' order by id_pedido_manual desc";   
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="first">
								...
								<td>
                                   <span class="label label-success"> <?php echo $reg["email_de_quien_llama"];?></span>
                                </td>
                                <td>
