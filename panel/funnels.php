...
<body>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper" class="form-page">
			<h3>Ingresar Datos de Funnel</h3><br><br>
            <div class="row form-wrapper">                							
						
				<!-- left column -->
                <div class="col-md-8 column">				
                    <form name="form" action="procesar-funnels" method="post">					
                        <div class="field-box">
						...
						<div class="field-box">
							<label>Numero de Impresiones</label>
							<div class="col-md-7">
								<input type="text"  value="" name="numero_de_impresiones" class="form-control inline-input" placeholder="ingrese numero de impresiones" />
							</div>
						</div>
						<div class="field-box">
							<label>Numero de Clics</label>
							<div class="col-md-7">
								<input type="text"  value="" name="numero_de_clics" class="form-control inline-input" placeholder="ingrese numero de clics" />
							</div>
						</div>
						<div class="field-box">
							<label>Costo de Adwords</label>
							<div class="col-md-7">
								<input type="text"  value="" name="costo_de_adwords" class="form-control inline-input" placeholder="ingrese costos de adwords" />
							</div>
						</div>					
						<div class="field-box">
