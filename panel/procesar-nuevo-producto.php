<?php
	...
	if($tipo == "image/png" or $tipo == "image/jpeg" or $tipo =="image/gif"){
		...
		values
		(null,'".$_POST["nombre_del_producto"]."','".$_POST["precio_del_producto"]."','".$_POST["orden_importancia"]."','".$_POST["tipo_de_producto"]."','".$_POST["colores_de_rosas"]."','".$_POST["unidades_de_rosas"]."','".$_POST["tamano_del_producto"]."','".$_POST["en_inventario"]."','".$_POST["producto_incluye"]."','".$_POST["ocasion_del_producto"]."','".$_POST["descripcion_del_producto"]."','$nombre_foto','$nombre_foto2','".$_POST["flor_1_principal"]."','".$_POST["unidades_flor_1_principal"]."','".$_POST["flor_2_principal"]."','".$_POST["unidades_flor_2_principal"]."','".$_POST["flor_3_principal"]."','".$_POST["unidades_flor_3_principal"]."','".$_POST["flor_1_secundaria"]."','".$_POST["unidades_flor_1_secundaria"]."','".$_POST["flor_2_secundaria"]."','".$_POST["unidades_flor_2_secundaria"]."','".$_POST["flor_3_secundaria"]."','".$_POST["unidades_flor_3_secundaria"]."','".$_POST["flor_1_terciaria"]."','".$_POST["unidades_flor_1_terciaria"]."','".$_POST["flor_2_terciaria"]."','".$_POST["unidades_flor_2_terciaria"]."','".$_POST["flor_3_terciaria"]."','".$_POST["unidades_flor_3_terciaria"]."','".$_POST["follaje_1_principal"]."','".$_POST["unidades_follaje_1_principal"]."','".$_POST["follaje_2_principal"]."','".$_POST["unidades_follaje_2_principal"]."','".$_POST["follaje_3_principal"]."','".$_POST["unidades_follaje_3_principal"]."','".$_POST["follaje_1_secundaria"]."','".$_POST["unidades_follaje_1_secundaria"]."','".$_POST["follaje_2_secundaria"]."','".$_POST["unidades_follaje_2_secundaria"]."','".$_POST["follaje_3_secundaria"]."','".$_POST["unidades_follaje_3_secundaria"]."','".$_POST["base_floral"]."','".$_POST["unidades_de_oasis"]."','".$_POST["unidades_de_cinta"]."','".$_POST["menos_de_90_min"]."','".$_POST["producto_padre"]."')		
		";
		...
		echo "<script type='text/javascript'>
			window.location='listado-productos.php?id_producto=$id';
		</script>";
