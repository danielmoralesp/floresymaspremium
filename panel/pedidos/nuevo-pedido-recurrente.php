...
<html>
<head>
	<title>Nuevo Pedido Recurrente | FloresyMas.co</title>
...
<body>
    ...
    <div class="content">     
        <div id="pad-wrapper" class="form-page">
			<h3>Nuevo Pedido Manual - Recurrente</h3><br><br>
            <div class="row form-wrapper">
				<!-- left column -->
                <div class="col-md-8 column">				
                    <form name="form" action="procesar-pedido-nuevo-recurrente" method="post" >					
						...
						<div class="field-box">
							<label>Año, Mes y Dia de Inicio:</label>
                            <div class="col-md-2">
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								...
								<div id="div_frecuencia_de_entrega"></div>
							</div>							
                        </div>
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								...
								<div id="div_numero_productos"></div>
							</div>							
                        </div>
						<div class="field-box">
