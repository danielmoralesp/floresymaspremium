<?php
	...
	$sql = "select * from pedido_manual where estado_pedido='realizado' and fecha_de_entrega='$fecha_de_dato' order by id_pedido_manual desc";   
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="first">
                                ...
                                <td>
                                    <span ><?php echo $reg["telefonos_de_quien_llama"];?></span>
                                </td>
                                <td>
