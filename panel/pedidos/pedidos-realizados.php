            ...
            <div class="table-wrapper orders-table section">
                ...
                <div class="row">
                    <table class="table table-hover">
                        ...
                        <tbody>
							<?php
								$sql2 = "select * from pedidos where estado_pedido='Realizado' order by id_pedidos desc";   	
                            ...
                            <tr class="first">
								...
								<td>
                                    <span class="label label-success"><?php echo $reg2["telefono_de_quien_llama"];?></span>
                                </td><td>
