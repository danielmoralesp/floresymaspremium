<?php
	...
	$res = mysql_query($sql,$con);		
		...
		if($_POST["estado_pedido"]=='Realizado'){
			...
			$asunto="Pago Confirmado y Pedido # ".$id_pedidos." en Produccion";
							...
							<div id="flashes">
								...
								<div class="cart" id="view_edit_cart">
									<div class="wrap-1100 center clear" id="heading">
										<h1>Pago Confirmado y Pedido # '.$_POST["id_pedidos"].' en Produccion</h1>
									</div>
									<div>
										<p>El Pago de su Pedido #  '.$_POST["id_pedidos"].' ha sido confirmado. Gracias por preferir a FloresyMas Premium!</p>
										<p>
											Su producto ha entrado en produccion para ser entregado el '.$_POST["dia_de_entrega"].'-'.$_POST["mes_de_entrega"].'-'.$_POST["ano_de_entrega"].'
											en el horario de '.$_POST["hora_de_entrega"].'. Le recomendamos ingresar a su cuenta de perfil con FloresyMas Premium para conocer el estado de 
											entrega de su producto, quien lo recibio y que observaciones hubo al momento de la entrega. 										
										</p>
									</div>
		...
		echo "<script type='text/javascript'>
				window.location = 'detalle-del-pedido.php?id_pedidos=$id_pedidos';
			</script>";
