						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_1_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_1_principal"]; ?>"><?php echo $reg2["flor_1_principal"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_1_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_1_principal"]; ?>"><?php echo $reg2["unidades_flor_1_principal"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_2_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_2_principal"]; ?>"><?php echo $reg2["flor_2_principal"]; ?></option>
									<option value="Hot Paris">Hot Paris</option>
									<option value="Jade">Jade</option>
									<option value="Vendela">Vendela</option>
                                </select>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_2_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_2_principal"]; ?>"><?php echo $reg2["unidades_flor_2_principal"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_3_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_3_principal"]; ?>"><?php echo $reg2["flor_3_principal"]; ?></option>
									<option value="Hot Paris">Hot Paris</option>
									<option value="Jade">Jade</option>
									<option value="Vendela">Vendela</option>
                                </select>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_3_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_3_principal"]; ?>"><?php echo $reg2["unidades_flor_3_principal"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_1_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_1_secundaria"]; ?>"><?php echo $reg2["flor_1_secundaria"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_1_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_1_secundaria"]; ?>"><?php echo $reg2["unidades_flor_1_secundaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_2_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_2_secundaria"]; ?>"><?php echo $reg2["flor_2_secundaria"]; ?></option>
									<option value="Astromelia">Astromelia</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_2_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_2_secundaria"]; ?>"><?php echo $reg2["unidades_flor_2_secundaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_3_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_3_secundaria"]; ?>"><?php echo $reg2["flor_3_secundaria"]; ?></option>
									<option value="Astromelia">Astromelia</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_3_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_3_secundaria"]; ?>"><?php echo $reg2["unidades_flor_3_secundaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_1_terciaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_1_terciaria"]; ?>"><?php echo $reg2["flor_1_terciaria"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_1_terciaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_1_terciaria"]; ?>"><?php echo $reg2["unidades_flor_1_terciaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_2_terciaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_2_terciaria"]; ?>"><?php echo $reg2["flor_2_terciaria"]; ?></option>
									<option value="Hortencias">Hortencias</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_2_terciaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_2_terciaria"]; ?>"><?php echo $reg2["unidades_flor_2_terciaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="flor_3_terciaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["flor_3_terciaria"]; ?>"><?php echo $reg2["flor_3_terciaria"]; ?></option>
									<option value="Hortencias">Hortencias</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_flor_3_terciaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_flor_3_terciaria"]; ?>"><?php echo $reg2["unidades_flor_3_terciaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="follaje_1_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["follaje_1_principal"]; ?>"><?php echo $reg2["follaje_1_principal"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_follaje_1_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_follaje_1_principal"]; ?>"><?php echo $reg2["unidades_follaje_1_principal"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="follaje_2_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["follaje_2_principal"]; ?>"><?php echo $reg2["follaje_2_principal"]; ?></option>
									<option value="Rusco">Rusco</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_follaje_2_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_follaje_2_principal"]; ?>"><?php echo $reg2["unidades_follaje_2_principal"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="follaje_3_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["follaje_3_principal"]; ?>"><?php echo $reg2["follaje_3_principal"]; ?></option>
									<option value="Rusco">Rusco</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_follaje_3_principal" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_follaje_3_principal"]; ?>"><?php echo $reg2["unidades_follaje_3_principal"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="follaje_1_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["follaje_1_secundaria"]; ?>"><?php echo $reg2["follaje_1_secundaria"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_follaje_1_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_follaje_1_secundaria"]; ?>"><?php echo $reg2["unidades_follaje_1_secundaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="follaje_2_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["follaje_2_secundaria"]; ?>"><?php echo $reg2["follaje_2_secundaria"]; ?></option>
									<option value="Helecho">Helecho</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_follaje_2_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_follaje_2_secundaria"]; ?>"><?php echo $reg2["unidades_follaje_2_secundaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="follaje_3_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["follaje_3_secundaria"]; ?>"><?php echo $reg2["follaje_3_secundaria"]; ?></option>
									<option value="Helecho">Helecho</option>
                                </select>
							</div>
							<div id="div_metodo_pago"></div>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_follaje_3_secundaria" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_follaje_3_secundaria"]; ?>"><?php echo $reg2["unidades_follaje_3_secundaria"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="base_floral" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["base_floral"]; ?>"><?php echo $reg2["base_floral"]; ?></option>
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_de_oasis" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_de_oasis"]; ?>"><?php echo $reg2["unidades_de_oasis"]; ?></option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>				
						...
						<div class="field-box">
                            ...
                            <div class="col-md-7">
								<select name="unidades_de_cinta" style="width:350px" class="select2"> 
									<option value="<?php echo $reg2["unidades_de_cinta"]; ?>"><?php echo $reg2["unidades_de_cinta"]; ?></option>
